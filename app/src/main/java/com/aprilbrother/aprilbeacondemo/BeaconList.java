...
public class BeaconList extends Activity {
	...
	private void requestLocationPermission() {
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
			...
			ActivityCompat.requestPermissions(this, new String[]{
					...
					Manifest.permission.ACCESS_FINE_LOCATION}, 001);
			Log.d("BeaconList", "requestPermissions");
		}
		...
		if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
				== PackageManager.PERMISSION_GRANTED) {
			Log.d("BeaconList", "ACCESS_COARSE_LOCATION PERMISSION_GRANTED");
		}

		if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
				== PackageManager.PERMISSION_GRANTED) {
			Log.d("BeaconList", "ACCESS_FINE_LOCATION PERMISSION_GRANTED");
		}
	}
	...
	public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
		Log.d("BeaconList", "onRequestPermissionsResult");
	}
}
